...
Since f(n+1)]not\in\{f(0),...,f(n)\}$,we have $f(n)<f(n+1)$\\
...
exercise: Prove that $Id_\mathbb{N} \rightarrow$ is the only isomorphism of partially ordered sets from $\mathbb{N} $ to $\mathbb{N} $
\end{document}
