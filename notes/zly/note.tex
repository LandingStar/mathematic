...
\begin{itemize}
    ...
    Therefore we can find $(I_i)_{i=1}^d$ are infinite subsets of $\mathbb{N}$ with $$I_1\supseteq ...\subseteq I_d$$ such that $(a_j)_{j\in I_i}^{(n)}$ converges to some $a_i\in K$. It follows that our original sequence has a convergent subsequence converges to $\sum\limits_{i=1}^da_ie_i$.
