...
\subsubsection{K-linear mapping}
...
\subsubsection{Proof:\quad$f$ is injection iff $\ker(f)=\{e_G\}$}
...
\subsection{Def} Let X be a set.We call sequence in X parametrized by I a mapping from I to X.
\subsection{Remark}
...
\end{itemize}
Then $(y_n)_{n\in I}$ tend to $l$
\subsubsection{Def}
Let I be an infinite subset of $\mathbb{N}$, adn $(x_n)_{n\in I}$ be a sequence in some set X. We call subsequence of $(x_n)_{n\in I}$ a sequence of the form $(x_n)_{n\in J}$,where J is an infinite subset of I
\subsubsection{Prop}
...
In particular, if $(x_n)_{n\in I}$ tend to $l\in[-\infty,+\infty]$,then $(x_n)_{n\in J}$ tends to $l$
\subsubsection{Prop}
$\forall n\in \mathbb{N} $,one has $$\liminf\limits_{n\in I,n\rightarrow+\infty}(x_n)\geq\liminf\limits_{n\in I,n\rightarrow+\infty}y_n$$$$\limsup\limits_{n\in I,n\rightarrow+\infty}(x_n)\leq\limsup\limits_{n\in I,n\rightarrow+\infty}y_n$$
\end{document}
